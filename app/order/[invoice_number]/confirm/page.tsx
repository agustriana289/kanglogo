...
export default function ConfirmPaymentPage({ params }: { params: { invoice_number: string } }) {
    ...
    if (loading) {
        return <div className="container mx-auto p-8 text-center">Memuat...</div>;
    }

    return (
        <section className="py-16 bg-white">
            <div className="container mx-auto max-w-2xl px-4">
                <h1 className="text-3xl font-bold text-center mb-8">Konfirmasi Pembayaran</h1>

                <form onSubmit={handleSubmit} className="space-y-6">
                    {/* Method Selection */}
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-3">Metode Konfirmasi</label>
                    ...
                    {proofMethod === 'file' && (
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mb-2">
                                Format: JPG, PNG, atau PDF. Maksimal 5MB. File akan diupload ke ImgBB.
                            </p>
                                ...
                                <div className="mt-1">
                                    ...
                                    >
                                        <div className="space-y-1 text-center">
                                            ...
                                            <p className="text-xs text-gray-500">JPG, PNG, PDF maksimal 5MB</p>
                                        </div>
                                    </label>
                                    <input
                                        id="proofFile"
                    ...
                    {proofMethod === 'url' && (
                        <div>
                            <label htmlFor="proofUrl" className="block text-sm font-medium text-gray-700">
                                URL Bukti Pembayaran
                            </label>
                            <p className="text-sm text-gray-500 mb-2">
                                Upload screenshot ke hosting gambar (Imgur, Google Drive, dll) lalu masukkan URL-nya.
                            </p>
                            <input
                                type="url"
                                id="proofUrl"
