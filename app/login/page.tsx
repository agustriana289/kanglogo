...
export default function LoginPage() {
  ...
  const logoUrl = 'https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi5kFe_bFCc6TRhYVg_FL5s7xjPyrXNGLFkRfVqfEUxhbJwCOC8mFPOzEOIzdvWWTh1UmM4guinMa8OHwK4n0zwclwZ5UArE28eWC6-v3EwpixIQYC12Mk1t4gyl-yNDzRhz7DmYt1PLtdBxBxpt8gQ8cUvIL_eENyP2_NbB_DRiuMLqSpM4R3tptUp70Yq/s600/Logo_Primary.webp';
          ...
          <form onSubmit={handleLogin}>
            <div className="mb-4">
              ...
              <input
                ...
                placeholder="agustriana289@gmail.com"
              />
            </div>
