...
export default function PurchaseModal({
    ...
    try {
      ...
      const { data, error } = await supabase
        ...
        .insert({
          ...
          status:
            asset.jenis === "freebies" || finalPrice === 0
              ? "completed"
              : "pending_payment",
        })
        .select()
  ...
  const inputStyle =
    "w-full rounded-lg border border-gray-300 py-2.5 px-4 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-2 focus:ring-primary focus:border-transparent focus:outline-none";
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        disabled={
                          checkingDiscount || !formData.discount_code.trim()
                        }
            ...
            {asset.jenis === "premium" ? (
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 text-left mb-6">
                <p className="text-sm text-yellow-800">
                  Silakan lakukan pembayaran dan konfirmasikan kepada kami. Kami
                  akan mengirimkan link download ke email Anda setelah
