...
import { ArrowDownTrayIcon, TagIcon, CalendarIcon } from "@heroicons/react/24/outline";
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center justify-between text-sm">
                                    ...
                                    <span className="font-semibold text-gray-900">{vector.downloads}</span>
                                </div>
                                <div className="flex items-center justify-between text-sm">
                                    <span className="text-gray-600 flex items-center gap-2">
                                    ...
                                    <span className="font-semibold text-gray-900">{vector.category}</span>
                                </div>
                                <div className="flex items-center justify-between text-sm">
                                    <span className="text-gray-600 flex items-center gap-2">
                                    ...
                                    <span className="font-semibold text-gray-900">{formatDate(vector.created_at)}</span>
                                </div>
                            </div>
                        </div>
